...
function ice_page_view_texte ($lang,$bdd,$table,$bookId,$pageOrder,$typeofbookDes) {
	...
	print "<!-- tableau d'affichage du texte et des facsimilés -->";
		...
		<tr>
			...
			<div align=\"center\"><img border=\"0\" src=\"../i-corpuspic/tab/$typeofbookDes/$valpage[bookTitleCollection]/$_GET[fig]\" alt=\"&copy CRHST-CNRS\"></img>
			</div>
			</p>
			</td>
		</tr>
	...
	<tr>
		...
		";		
			...
			<td width=\"20%\" valign=\"top\">
				<div align=\"center\">
				<p>
				<a href=\"$_SERVER[PHP_SELF]?$_SERVER[QUERY_STRING]&facsimile=on\">
				...
				if ($valpage['pagefigure1']) {
					print "<p>
					<a href=\"$_SERVER[PHP_SELF]?$_SERVER[QUERY_STRING]&fig=$valpage[pagefigure1]\">
				...
				if ($valpage['pagefigure2']) {
					print "<p>
					<a href=\"$_SERVER[PHP_SELF]?$_SERVER[QUERY_STRING]&fig=$valpage[pagefigure2]\">
				...
				if ($valpage['pagefigure3']) {
					print "<p>
					<a href=\"$_SERVER[PHP_SELF]?$_SERVER[QUERY_STRING]&fig=$valpage[pagefigure3]\">
	...
	<tr>
		<td>
		<a lang=\"$GET_[lang]\" href=\"$_SERVER[PHP_SELF]?lang=$_GET[lang]&type=$_GET[type]&bdd=$_GET[bdd]&table=$_GET[table]&bookId=$_GET[bookId]&typeofbookDes=$_GET[typeofbookDes]&pageOrder=$_GET[pageOrder]&facsimile=off\">
		"; 
