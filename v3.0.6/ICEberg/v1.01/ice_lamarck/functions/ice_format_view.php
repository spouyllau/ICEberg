...
<tr>
	<td>Page : <strong>$pageNumber</strong></td>	
	<td align=\"right\">
				";
				if ($pageNumberp >= $prepag) {
					print "<a href=\"$_SERVER[PHP_SELF]?lang=$_GET[lang]&type=$_GET[type]&bdd=$_GET[bdd]&table=$_GET[table]&bookId=$_GET[bookId]&typeofbookDes=$_GET[typeofbookDes]&pageOrder=$pageNumberp&facsimile=$_GET[facsimile]\">
					<strong><<<</strong></a>&nbsp;";
				} else { }
				print "Page : <strong>$pageNumber</strong>";
				if ($pageNumbers <= $derpag) {
					print "&nbsp;<a href=\"$_SERVER[PHP_SELF]?lang=$_GET[lang]&type=$_GET[type]&bdd=$_GET[bdd]&table=$_GET[table]&bookId=$_GET[bookId]&typeofbookDes=$_GET[typeofbookDes]&pageOrder=$pageNumbers&facsimile=$_GET[facsimile]\"><strong>>>></strong></a>";
				} else { }
				print "
	</td>
</tr>
